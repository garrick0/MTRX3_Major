                ...
                switch(*state_variable){
                    ...
                    case NORMAL:
                        if(*userinput==Abutton){
                            //(UIInput->State)=USER_MANUAL_MODE;
                        ...
                        if(*userinput==Abutton){
                            if((*menu_position)!=3){
                                *state_variable=PARAMETER;
                                ...
                                (UIInput->State)=USER_AUTO_MODE;   //request
                                *state_variable=ENTRY;
                                *menu_position=0;
                            ...
                            switch(*menu_position){
                                case 0:
                                	*state_variable=PARAMETER;
                                    break;
                                case 1:
                                    (UIInput->State)=USER_MANUAL_MODE; //request
                                    *menu_position=0;
                                    *state_variable=ENTRY;
                                    break;
                            }

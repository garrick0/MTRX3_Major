/**
 * @file StateTransition.c
 * @date October 2016
 * @brief Determines state transitions within UI 
 * 
 * Causes state transitions with UI based on current state and user input.
 * Also outputs parameter changes, menu scrolling, movement commands, and 
 * state changes.
 * 
...
/** Passcode requirement. Checks user input when prompted to enter 
 * passcode. Returns value based on inputs.
 */
char passcode[]= "UU";
int i=0;
int success;
...
/** Delay for 1.5 sceonds. Function called in main.c and StateTransition
 * Implements a delay of 1.5 seconds for LCD display.
 */
int setup=0;
...
/** Transitions state based on input. Changes values in struct or
 * other values based on user input. Uses switch and if statements
 * to determine current state of UI module.
 */
